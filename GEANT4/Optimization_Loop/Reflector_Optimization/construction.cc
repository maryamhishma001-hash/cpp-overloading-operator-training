...
G4VPhysicalVolume *MyDetectorConstruction::Construct()
{
    ...
    G4double fixedModeratorThickness = 34.0 * cm;
    G4double hzModerator = fixedModeratorThickness / 2.0;
    
    G4cout << "\n*** CONSTRUCTING REFLECTOR STAGE: fixed moderator = 34.0 cm, reflector thickness = "
        << fReflectorThickness / cm
        << " cm ***\n" << G4endl;
    ...
    G4Box *solidOuterReflector = new G4Box("solidOuterReflector", 
                                          bsaX + fReflectorThickness, 
                                          bsaY + fReflectorThickness, 
                                          reflectorHalfLength);
...
void MyDetectorConstruction::SetReflectorThickness(G4double val)
{
    ...
    G4cout << "\n========================================\n";
    G4cout << "REFLECTOR THICKNESS SET TO: "
            << fReflectorThickness / cm
            << " cm\n";
    G4cout << "========================================\n"
            << G4endl;
