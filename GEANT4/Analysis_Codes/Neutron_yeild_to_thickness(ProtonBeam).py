...
Y-axis max set to 7000 and Title fontsize set to 14.
"""
...
ax.set_title("Neutron Yield vs. Li Target Thickness for Divergent Proton Beam ($E_p = 2.2 \pm 0.2\ \mathrm{MeV}$)",
             fontsize=14, fontweight="bold", pad=14)

# Set lower and upper limits (Max Y = 7000)
ax.set_xlim(0, 165)
ax.set_ylim(0, 7000)
