...
void MySteppingAction::UserSteppingAction(const G4Step* step)
{
    ...
    if (step->GetPostStepPoint()->GetStepStatus() == fGeomBoundary) 
    {
        ...
        if (volumeTo == "physDetector")
        {
            ...
            if (cosTheta > 0.0) 
            {
              ...
              // ICRU Report 63, Table C.3
              // Total neutron kerma coefficients for AIR
              // Original unit: fGy m^2
              // Converted unit: Gy cm^2 = value * 1e-11
    ...
    2.53e-11, 2.59e-11, 2.65e-11, 2.70e-11, 2.76e-11, 2.81e-11, 2.86e-11, 2.91e-11, 2.95e-11};
                        ...
                        // [تعديل هام]: تم استخدام fluxWeight بدلاً من weight لضمان الاتساق
                ...
                else if (particleName == "gamma") 
                {
                 ...
                 // ICRU Report 57, Table A.1 — Conversion coefficients for air kerma per unit fluence of monoenergetic photons free-in-air
                 // Quantity: K_a / Phi
                 // Original unit: pGy cm^2
                 // Converted unit: Gy cm^2 = value * 1e-12
    ...
    1.21e-11, 1.41e-11, 1.61e-11, 2.01e-11, 2.40e-11};
                    ...
                    // [تعديل هام]: استخدام fluxWeight لتجميع كيرما أشعة غاما بشكل متسق مع الفلُكس
